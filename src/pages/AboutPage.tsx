...
const TeamCarousel = () => {
  ...
  return (
    <section ref={sectionRef} className="bg-[#121212] py-20 md:py-28 text-[#F2EAD9] relative overflow-hidden w-full">
      {/* Brand Dashed Section Divider Line */}
      ...
      <div className="w-full px-6 md:px-12 lg:px-16 max-w-[1700px] mx-auto relative z-10 space-y-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-2">
          <div>
            <div className="overflow-hidden">
              ...
              >
                EQUIPE <span className="text-[#5E308A]">HYPECUT</span>
              </motion.h2>
            </div>
          </div>
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 z-10 flex flex-col gap-2">
                ...
                <a
                  ...
                  className="mt-2 w-full py-3 bg-[#5E308A] hover:bg-[#4A2370] text-white text-xs font-black uppercase tracking-wider rounded-none flex items-center justify-center gap-2 transition-all duration-300 shadow-lg"
                >
        ...
        {/* DESKTOP HORIZONTAL STORY CAROUSEL (>=768px) */}
        <div
          ref={carouselRef}
  ...
  return (
    <div className="bg-[#121212] min-h-screen text-text-primary font-sans selection:bg-[#5E308A] selection:text-white">
      ...
      <main className="pt-0">
        ...
        <section className="py-12 pb-16 bg-[#121212] relative z-20">
          <div className="max-w-4xl mx-auto px-6 md:px-12 space-y-10 text-text-primary/90 leading-relaxed font-medium">
            ...
            <motion.div
              ...
              className="space-y-4"
            >
              <h2 className="text-xl md:text-3xl font-black uppercase text-text-primary tracking-tight">
            ...
            >
              <h3 className="text-lg md:text-2xl font-black uppercase text-text-primary tracking-tight">
                NOSSO COMPROMISSO
              </h3>
              <p className="text-sm md:text-base">
              ...
              <p className="text-sm md:text-base">
                Disponibilizamos um ambiente moderno e um sistema de agendamento eficiente pelo App Barber, garantindo um atendimento ágil, exclusivo e de alto nível. Nossa equipe, altamente qualificada e experiente, entrega resultados impecáveis e alinhados às suas expectativas.
              </p>
            </motion.div>
            ...
            >
              ...
              <ul className="space-y-2 text-sm md:text-base pl-4 text-text-primary/90">
                <li className="flex items-center gap-2">• Barboterapia com toalha quente</li>
                <li className="flex items-center gap-2">• Limpeza facial</li>
                <li className="flex items-center gap-2">• Sobrancelhas</li>
                <li className="flex items-center gap-2">• Limpeza de ouvidos e nariz com cera</li>
                <li className="flex items-center gap-2">• Aplicação e manutenção de prótese capilar não cirúrgica</li>
                <li className="flex items-center gap-2">• Coloração e pigmentação de cabelos e barbas</li>
              </ul>
              <p className="text-sm md:text-base pt-2 font-semibold text-text-primary">
            ...
            >
              ...
              <p className="text-sm md:text-base">
                Proporcionamos um ambiente descontraído e aconchegante, onde cada visita se transforma em um momento de lazer, relaxamento e cuidado pessoal.
              </p>
            </motion.div>
        ...
        {/* Story Carousel with Full Team Info Restored */}
        <TeamCarousel />
